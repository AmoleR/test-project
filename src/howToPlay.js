  ...
  render() {
    return(
      <div id="background">
        ...
        <Hexagon commodityType={0} letter={'A'}/>
        <br />
        There are 5 types of these hexes (ore, wheat, wood, sheep, and brick, in that order):
        <div style={{display: 'flex', flexFlow: 'row nowrap'}}>
          <Hexagon commodityType={0} letter={'A'}/>
          <Hexagon commodityType={1} letter={'A'}/>
          <Hexagon commodityType={2} letter={'A'}/>
          <Hexagon commodityType={3} letter={'A'}/>
          <Hexagon commodityType={4} letter={'A'}/>
        </div>
        <br />
        ...
        <Hexagon commodityType={5} letter={' '}/>
        ...
        <div style={{textAlign: 'center'}}>
          ...
          <HexagonRow commodityArray = {[1, 2]} letterArray = {['B', 'C']} />
        ...
        <div style={{textAlign: 'center'}}>
          <div style={{marginLeft: '264px'}} >
            <Hexagon commodityType={3} letter={'O'} />
          </div>
          <HexagonRow commodityArray = {[4, 0]} letterArray = {['P', 'Q']}/>
          <div style={{position: 'relative'}}>
        ...
        <ul>
          ...
          <div style={{textAlign: 'center'}}>
            <div style={{marginLeft: '264px'}} >
              <Hexagon commodityType={0} letter={'D'} />
            </div>
            <HexagonRow commodityArray = {[1, 3]} letterArray = {['E', 'F']}/>
            <div style={{position: 'relative'}}>
          ...
          <div style={{textAlign: 'center'}}>
            <div style={{marginLeft: '264px'}} >
              <Hexagon commodityType={3} letter={'G'} />
            </div>
            <HexagonRow commodityArray = {[4, 0]} letterArray = {['H', 'I']}/>
            <div style={{position: 'relative'}}>
          ...
          <div style={{textAlign: 'center'}}>
            <div style={{marginLeft: '264px'}} >
              <Hexagon commodityType={1} letter={'J'} />
            </div>
            <HexagonRow commodityArray = {[3, 2]} letterArray = {['K', 'L']}/>
            <div style={{position: 'relative'}}>
